...
mf.chkfile =    './output/hs_bp86_MCSCF_FeScu_36o_54e_00005.chk'
mf.max_cycle = 500
mf.conv_tol = 1.e-4
mf.xc = 'b88,p86' 
...
mf2.chkfile =   './output/hs_bp86_MCSCF_FeScu_36o_54e_00005.chk'
mf2.conv_tol = 1.e-12
...
tools.molden.from_mo(mol, 'FeScu_DFT.molden')
