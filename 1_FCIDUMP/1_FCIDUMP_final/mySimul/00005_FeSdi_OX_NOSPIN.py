...
mol.basis = 'tzp-dkh'
mol.charge = -2			# FeS_OX
mol.spin = 0 			# NOT 2S+1 but S_A - S_B
...
mf.chkfile =    './output/00005_hs_bp86_MCSCF_FeSdi_OX_20o_30e_NOSPIN.chk'
mf.max_cycle = 500
mf.conv_tol = 1.e-4
mf.xc = 'b88,p86' 
...
mf2.chkfile =   './output/00005_hs_bp86_MCSCF_FeSdi_OX_20o_30e_NOSPIN.chk'
mf2.conv_tol = 1.e-12
...
mo = mf2.mo_coeff               
norb = 12 
nelec = [7, 7] 		        # [ # of alpha e, # of beta e ]
...
act_cp_op = [78, 84]
			        # p-orbitals of S...
#act_d = [87, 88, 91, 92, 93, 94, 95, 96, 97, 98]
...
header =""" &FCI NORB=12,NELEC=14,MS2=0,
 ...
 &END
"""
dumpERIs('./output/00005_MCSCF_FeSdi_OX_12o_14e_NOSPIN.FCIDUMP', header, int1e=h1e, int2e=g2e, ecore=ecore)       
